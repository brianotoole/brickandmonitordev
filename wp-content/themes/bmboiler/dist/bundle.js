...
},{"./bundle-url":"../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"entry.scss":[function(require,module,exports) {
...
headroom.init(); // Nav toggle on click event
...
var ctrl = new ScrollMagic.Controller({//addIndicators: true //debug only, requires 'debug.addIndicators.min.js'
});
...
var tl = new TimelineMax({});
tlLoading.staggerTo(".loader-text span", .5, {
  color: "#999",
  scale: 1.05
